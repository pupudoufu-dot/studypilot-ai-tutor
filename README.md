...
仓库内置 210 条**合成场景**：200 条模板生成场景（40 个知识点 × 5 类错因）与 10 条独立挑战场景。挑战场景覆盖否定表达、冲突证据与证据不足，比较一个窄关键词、无 Fallback 的内部基线和 StudyPilot 工作流：

| 指标 | 内部基线 | StudyPilot |
|---|---:|---:|
| 错因识别准确率 | 124/210（59.0%） | 194/210（92.4%） |
| 低置信场景硬判断率 | 20/20（100.0%） | 0/20（0.0%） |
| 首轮答案暴露率 | 210/210（100.0%） | 0/210（0.0%） |
